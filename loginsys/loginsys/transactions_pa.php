...
<?php $row = Core::getRowById(Core::trTable, Filter::$id);?>
<p class="bluetip"><i class="icon-lightbulb icon-3x pull-left"></i> Here you can see your transaction history<br>
  </p>
    ...
    <table class="myTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="tbicon"> <a href="index.php?do=users&amp;action=edit&amp;id=<?php echo $row->id;?>" class="tooltip" data-title="Aprove"><i class="icon-pencil"></i></a> </span>
            
            <span class="tbicon"> <a id="item_<?php echo $row->id;?>" class="tooltip delete" data-rel="<?php echo $row->username;?>" data-title="Reject"><i class="icon-trash"></i></a> </span>
            </td>
