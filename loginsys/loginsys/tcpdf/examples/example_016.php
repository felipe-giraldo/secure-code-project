...
*/
$pass = $_SESSION['pdf_password'];
$pdf->SetProtection(array('print', 'copy'), $pass, null, 0, null);
...
$pdf->SetAuthor('FivePlus Bank');
$pdf->SetTitle('TAN Holder');
$pdf->SetSubject('SecureCode Example');
...
$message = $_SESSION['pdf_with_tokens'];
...
$pdf->Output($temp_dir . '/' . $file_name , 'F');
